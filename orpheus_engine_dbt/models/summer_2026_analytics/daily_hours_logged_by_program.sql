...
-- The in-progress Eastern day is excluded because same-day data is incomplete.
...
WHERE (activity_hour AT TIME ZONE 'America/New_York')::date < (NOW() AT TIME ZONE 'America/New_York')::date
GROUP BY 1, 2
